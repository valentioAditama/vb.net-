...
Module Program
    Sub Main(args As String())
        ...
        Console.WriteLine("3. Menampilkan 12 Bulan")
        ...
        Try
            ...
            ElseIf choose = 3 Then
                Dim pilih_bulan As Int32
                Console.WriteLine("Perhitungan 12 Bulan")
                Console.Write("Masukan Nomor Bulan > ")
                pilih_bulan = Console.ReadLine()
                Select Case pilih_bulan
                    Case 1
                        Console.WriteLine("Bulan ke-{0} Adalah Januari", pilih_bulan)
                    Case 2
                        Console.WriteLine("Bulan ke-2 Adalah Febuari")
                    Case 3
                    ...
                    Case Else
                        Console.WriteLine("Ga ada bulan ke-{0}", pilih_bulan)
                End Select
